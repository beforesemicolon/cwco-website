...
module.exports = {
  ...
  documentation: [
    ...
    {label: en.menu.documentation.creatingComponents, link: "/documentation/creating-components", subMenu: []},
    {label: en.menu.documentation.componentsLifecycles, link: "/documentation/component-lifecycles", subMenu: []},
    {label: en.menu.documentation.attrAndProps, link: "/documentation/attributes-and-properties", subMenu: []},
    {label: en.menu.documentation.template, link: "/documentation/template", subMenu: []},
    {label: en.menu.documentation.directive, link: "/documentation/directive", subMenu: []},
